...
*/
        final String imageFile =".\\images\\me.jpg";
        final String outputFile =".\\ExcelFile\\DimensionedImage.xls";
        ...
        try (final Workbook workbook = new HSSFWorkbook();
            ...
            new AddDimensionedImage().addImageToSheet("D5", sheet, sheet.createDrawingPatriarch(),
                    new File(imageFile).toURI().toURL(), 50, 40,
                    AddDimensionedImage.EXPAND_ROW_AND_COLUMN);
            workbook.write(fos);
        }
    }
